...
--
-- Host: localhost    Database: test_linked_1
-- ------------------------------------------------------
...
CREATE TABLE `advertisements` (
  ...
  `external_url` varchar(191) NOT NULL,
  ...
  `type` varchar(191) DEFAULT NULL COMMENT 'Promotional or advertisement',
  `count` int(11) NOT NULL DEFAULT 0,
  `show_on` enum('mobile','web','both') NOT NULL DEFAULT 'both',
...
INSERT INTO `advertisements` VALUES (1,'https://aust.linkedhill.com.np//storage/photos/1/ads/ads2.jpg','Home Ads','https://www.youtube.com/','news','news_header',0,'top',NULL,0,'web',1,'2022-12-25 10:30:07','2022-08-18 07:49:21','2022-12-25 10:30:07'),(2,'https://aust.linkedhill.com.np//storage/photos/1/ads/ads2.jpg','Property page','https://www.youtube.com/','property','property_header',0,'top',NULL,0,'web',1,'2022-12-25 10:30:04','2022-08-18 07:50:23','2022-12-25 10:30:04'),(3,'https://aust.linkedhill.com.np//storage/photos/1/ads/ads2.jpg','news','https://www.youtube.com/','home','home_header',0,'top',NULL,0,'web',1,NULL,'2022-08-19 04:24:18','2022-12-25 10:21:28'),(4,'https://aust.linkedhill.com.np//storage/photos/1/ads2.jpg','blog ads','https://www.youtube.com/','property','property_header',0,'top',NULL,0,'web',1,NULL,'2022-08-19 04:26:39','2022-12-23 04:31:56');
...
CREATE TABLE `agency_details` (
  ...
  `type` varchar(191) NOT NULL COMMENT 'individual,company,.....',
  `agency_name` varchar(30) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'verified,unverified,rejected,blocked',
  `status_remarks` varchar(191) DEFAULT NULL,
  `address` varchar(191) DEFAULT NULL,
  `logo` varchar(100) DEFAULT NULL,
  `website` varchar(100) DEFAULT NULL,
  `agency_phone` varchar(191) DEFAULT NULL,
  `agency_mobile` varchar(191) DEFAULT NULL,
  `agency_email` varchar(191) DEFAULT NULL,
  `company_reg_no` varchar(191) DEFAULT NULL,
  `pan` varchar(191) DEFAULT NULL,
  `company_registration` varchar(191) DEFAULT NULL,
  `tax_clearance` varchar(191) DEFAULT NULL,
  `national_id` varchar(191) DEFAULT NULL,
  `vat_pan_no` varchar(191) DEFAULT NULL,
  `verified_at` timestamp NULL DEFAULT NULL,
  `short_intro` mediumtext DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `agency_details` VALUES (39,150,'Real Estate Company','Bishesh Rana',1,NULL,'bypass','https://aust.linkedhill.com.np//images/logo/1669116366_MG_8226.jpg','https://www.daraz.com.np/','9846803262','9846803262','bishesh.nectar@gmail.com','1233223','https://aust.linkedhill.com.np//images/pan/1669116366_MG_8226.jpg','https://aust.linkedhill.com.np//documents/16691163662021-07-16 to 2022-07-16 balancesheet_report_filter (1).pdf','https://aust.linkedhill.com.np//documents/16691163662021-07-16 to 2022-07-16 balancesheet_report_filter (2).pdf',NULL,NULL,NULL,NULL,'2022-11-22 05:41:06','2022-11-22 05:42:40',NULL),(40,158,'','Nischal',1,NULL,'asa',NULL,'mm','9847838180','9847838183','adminnischal@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-12-15 05:31:07','2022-12-21 00:55:15','2022-12-21 00:55:15'),(41,159,'','Preston Gallegos',1,NULL,'Ratione aperiam atqu',NULL,'https://www.kekaqosupaqy.co.uk','9875456321','9875456321','lebawyqo@mailinator.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-12-15 05:57:27','2022-12-21 00:55:19','2022-12-21 00:55:19'),(43,169,'Real Estate Company','my company',0,NULL,'ktm',NULL,NULL,NULL,'9847838183','nischalsapkota977@gmail.com','123',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-12-20 04:19:16','2022-12-22 01:50:44','2022-12-22 01:50:44'),(44,172,'Builder/ Developer','builder cpmpany',0,NULL,'ktm',NULL,NULL,'1231231233','984783000','nn@gmail.com','123',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-12-20 05:03:05','2022-12-20 05:04:17',NULL),(45,173,'Individual Agent','individual agent',0,NULL,'ktm',NULL,NULL,NULL,'987654359','individualagent@gmail.com',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2022-12-20 05:09:00','2022-12-21 04:09:11',NULL),(46,174,'Individual Agent','agent individual',2,NULL,'Ab doloribus asperio',NULL,'https://www.gaxypucemopiwa.us',NULL,'9876541326','fefyqe@mailinator.com',NULL,NULL,NULL,NULL,'54',NULL,NULL,NULL,'2022-12-20 05:09:32','2022-12-21 05:14:38','2022-12-21 05:14:38'),(47,179,'Individual Agent','i agent',1,'s','ktm',NULL,NULL,'1231231233','9810083818','indiagent@gmail.com',NULL,NULL,NULL,NULL,'123',NULL,NULL,NULL,'2022-12-21 05:16:31','2022-12-22 03:41:33',NULL);
...
CREATE TABLE `agency_property` (
  ...
  CONSTRAINT `agency_property_agency_id_foreign` FOREIGN KEY (`agency_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `agency_property_owner_id_foreign` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `agency_property_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `agency_property` VALUES (1,20,150,NULL,'2022-12-14 00:59:23','2022-12-14 00:59:23'),(2,22,178,150,'2022-12-21 01:48:32','2022-12-21 01:48:32'),(3,24,178,150,'2022-12-21 02:31:24','2022-12-21 02:31:24'),(4,25,172,NULL,'2022-12-22 01:53:45','2022-12-22 01:53:45'),(5,27,178,150,'2022-12-22 04:48:46','2022-12-22 04:48:46');
...
INSERT INTO `areas` VALUES (1,1,'dharahara','dharahara','2022-08-18 07:05:56','2022-08-18 07:05:56'),(2,774,'A1','a1','2022-11-07 00:27:57','2022-11-07 00:27:57');
...
CREATE TABLE `chat_categories` (
  ...
  `publish_status` enum('1','0') NOT NULL DEFAULT '1',
  `created_by` bigint(20) unsigned DEFAULT NULL,
  `thumbnail` varchar(191) DEFAULT NULL,
  `path` varchar(191) DEFAULT NULL,
  `external_link` varchar(191) DEFAULT NULL,
  `slug` varchar(191) DEFAULT NULL,
  `isMainMenu` enum('0','1') NOT NULL DEFAULT '0',
...
CREATE TABLE `chat_messages` (
  ...
  `messageFrom` enum('admin','user') NOT NULL DEFAULT 'user',
  `message_by` enum('bot','user') NOT NULL DEFAULT 'bot' COMMENT 'if  message by bot condition',
  `text` text DEFAULT NULL,
  `file` text DEFAULT NULL,
  `sender_seen` enum('seen','unseen') NOT NULL DEFAULT 'seen',
  `receiver_seen` enum('seen','unseen') NOT NULL DEFAULT 'unseen',
  `sender_action` enum('1','0') NOT NULL DEFAULT '0',
  `receiver_action` enum('1','0') NOT NULL DEFAULT '0',
  `messageIn` varchar(191) DEFAULT NULL COMMENT 'en/np/lang',
...
CREATE TABLE `customers` (
  ...
  `social_from` enum('facebook','google','normal') NOT NULL DEFAULT 'normal',
  `email_verified_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `device_credentials` (
  ...
  `agent` varchar(191) NOT NULL COMMENT 'browser that users logged in with',
...
CREATE TABLE `districts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `np_name` varchar(30) DEFAULT NULL,
  `en_name` varchar(30) DEFAULT NULL,
  `en_slug` varchar(30) DEFAULT NULL,
  `np_slug` varchar(30) DEFAULT NULL,
...
INSERT INTO `enquiries` VALUES (1,'jovigahoj@mailinator.com','hedej@mailinator.com','nuwuzykuwo@mailinator.com','putara@mailinator.com','Quidem corporis quib',NULL,'2022-12-15 23:06:36','2022-12-15 23:06:36'),(2,'qiqozaby@mailinator.com','syvydihuw@mailinator.com','vuneki@mailinator.com','zavicimob@mailinator.com','Aspernatur optio vi',NULL,'2022-12-15 23:09:44','2022-12-15 23:09:44'),(3,'Macaulay Barry','cynyb@mailinator.com','9847838183','Obcaecati totam rati','Consequatur adipisci',20,'2022-12-15 23:27:33','2022-12-15 23:27:33'),(4,'Ryan Evans','voxuzof@mailinator.com','Velit modi autem rat','Ut anim quo nulla al','Qui illo quisquam au',20,'2022-12-15 23:27:52','2022-12-15 23:27:52'),(5,'Ahmed Hardin','bemyn@mailinator.com','3656','Deleniti qui proiden','Do earum aspernatur',20,'2022-12-16 00:59:04','2022-12-16 00:59:04'),(6,'kehys@mailinator.com','makenylu@mailinator.com','9847888','cimis@mailinator.com','Magna sed sunt sit',NULL,'2022-12-16 02:26:11','2022-12-16 02:26:11'),(7,'Kyra Carey','wunimy@mailinator.com','Quidem rerum delectu','Sit minus aut quas','Minim qui hic ad und',19,'2022-12-16 03:46:23','2022-12-16 03:46:23'),(8,'vebyger@mailinator.com','popacowal@mailinator.com','becuv@mailinator.com','goru@mailinator.com','Ad in atque iste vol',NULL,'2022-12-16 03:46:40','2022-12-16 03:46:40'),(9,'vebyger@mailinator.com','popacowal@mailinator.com','becuv@mailinator.com','goru@mailinator.com','Ad in atque iste vol',NULL,'2022-12-16 03:46:59','2022-12-16 03:46:59'),(10,'vebyger@mailinator.com','popacowal@mailinator.com','becuv@mailinator.com','goru@mailinator.com','Ad in atque iste vol',NULL,'2022-12-16 03:47:05','2022-12-16 03:47:05'),(11,'Shellie Strickland','dopucofix@mailinator.com','Elit eiusmod omnis','Minima neque quasi d','Aliquip quo sint am',19,'2022-12-16 03:47:20','2022-12-16 03:47:20'),(12,'zuper@mailinator.com','wamuwi@mailinator.com','vyqigus@mailinator.com','hule@mailinator.com','Quis quia ut asperio',NULL,'2022-12-16 03:47:33','2022-12-16 03:47:33'),(13,'gyretono@mailinator.com','julene@mailinator.com','qomuboto@mailinator.com','gezisil@mailinator.com','Est necessitatibus d',NULL,'2022-12-16 03:48:40','2022-12-16 03:48:40'),(14,'wazytulec@mailinator.com','pavedom@mailinator.com','voqu@mailinator.com','rypobab@mailinator.com','Quae eum eligendi ea',NULL,'2022-12-16 03:56:17','2022-12-16 03:56:17'),(15,'wazyt
2022-12-21 05:40:23'),(12,'Water Facility',3,'2022-12-21 05:37:18','2022-12-21 05:40:23'),(13,'Cable Connection',4,'2022-12-21 05:37:26','2022-12-21 05:40:23'),(14,'Close To School',5,'2022-12-21 05:37:35','2022-12-21 05:40:23'),(15,'Close to Hospital',6,'2022-12-21 05:37:41','2022-12-21 05:40:23'),(16,'Lift',7,'2022-12-21 05:37:46','2022-12-21 05:40:23'),(17,'Intercom',8,'2022-12-21 05:37:50','2022-12-21 05:40:23'),(18,'Security Gate',9,'2022-12-21 05:37:56','2022-12-21 05:40:23'),(19,'Drainage',11,'2022-12-21 05:38:03','2022-12-21 05:40:23'),(20,'Solar',12,'2022-12-21 05:38:09','2022-12-21 05:40:23'),(21,'Swimming Pool',13,'2022-12-21 05:38:18','2022-12-21 05:40:23'),(22,'Fireplace',16,'2022-12-21 05:38:24','2022-12-21 05:40:23'),(23,'Outdoor BBQ',15,'2022-12-21 05:38:32','2022-12-21 05:40:23'),(24,'Gym',14,'2022-12-21 05:38:35','2022-12-21 05:40:23');
...
CREATE TABLE `favorite_properties` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `favorite_properties_user_id_foreign` (`user_id`),
  KEY `favorite_properties_property_id_foreign` (`property_id`),
  CONSTRAINT `favorite_properties_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `favorite_properties_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `favourite_lists` VALUES (5,10,1,'2022-11-22 06:23:21','2022-11-22 06:23:21'),(8,8,1,'2022-11-30 02:13:29','2022-11-30 02:13:29'),(10,2,1,'2022-12-01 04:43:25','2022-12-01 04:43:25'),(13,18,1,'2022-12-01 23:14:59','2022-12-01 23:14:59'),(16,19,150,'2022-12-15 04:42:52','2022-12-15 04:42:52'),(17,19,155,'2022-12-17 23:12:20','2022-12-17 23:12:20'),(22,22,1,'2022-12-21 22:37:24','2022-12-21 22:37:24'),(24,20,1,'2022-12-21 22:39:29','2022-12-21 22:39:29'),(31,21,171,'2022-12-22 00:32:31','2022-12-22 00:32:31'),(32,19,171,'2022-12-22 00:32:53','2022-12-22 00:32:53'),(33,20,171,'2022-12-22 00:51:19','2022-12-22 00:51:19'),(34,20,172,'2022-12-22 00:55:11','2022-12-22 00:55:11'),(35,19,172,'2022-12-22 00:56:58','2022-12-22 00:56:58'),(46,25,150,'2022-12-22 05:00:52','2022-12-22 05:00:52'),(48,19,1,'2023-01-08 06:54:06','2023-01-08 06:54:06');
...
CREATE TABLE `feature_property` (
  ...
  CONSTRAINT `feature_property_feature_id_foreign` FOREIGN KEY (`feature_id`) REFERENCES `features` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `feature_property_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `feature_property` VALUES (32,17,19,'10+',NULL,NULL),(41,10,19,'6',NULL,NULL),(42,10,18,'3',NULL,NULL),(43,18,17,'semi-furnish',NULL,NULL),(44,18,18,'3',NULL,NULL),(45,18,19,'8',NULL,NULL),(46,18,20,'6',NULL,NULL),(47,18,21,'4',NULL,NULL),(50,5,19,'8+',NULL,NULL),(52,2,24,'Ploted',NULL,NULL),(55,5,18,'2',NULL,NULL),(56,5,20,'2',NULL,NULL),(57,5,21,'5',NULL,NULL),(59,5,26,'2',NULL,NULL),(61,19,18,'2',NULL,NULL),(62,19,19,'8+',NULL,NULL),(63,19,20,'2',NULL,NULL),(64,19,21,'4',NULL,NULL),(66,19,26,'true',NULL,NULL),(67,21,17,'Fully-furnish',NULL,NULL),(68,21,25,'Ready to move/Newly built',NULL,NULL),(69,21,26,'1',NULL,NULL),(70,22,21,'8',NULL,NULL),(73,22,26,'true',NULL,NULL),(74,24,21,'8',NULL,NULL),(77,24,26,'2',NULL,NULL),(78,25,17,'Semi-furnish',NULL,NULL),(79,25,18,'2',NULL,NULL),(80,25,19,'6+',NULL,NULL),(81,25,20,'2',NULL,NULL),(82,25,21,'3',NULL,NULL),(83,25,25,'Under construction',NULL,NULL),(84,25,26,'2 year',NULL,NULL),(86,26,18,'2',NULL,NULL),(88,26,20,'2',NULL,NULL),(89,26,21,'2',NULL,NULL),(92,27,17,'Semi-furnish',NULL,NULL),(93,27,18,'2',NULL,NULL),(94,27,19,'3+',NULL,NULL),(95,27,20,'2',NULL,NULL),(96,27,21,'8',NULL,NULL),(97,27,25,'Ready to move/Newly built',NULL,NULL),(98,27,26,'20+ year',NULL,NULL);
...
CREATE TABLE `feature_property_category` (
  ...
  CONSTRAINT `feature_property_category_feature_id_foreign` FOREIGN KEY (`feature_id`) REFERENCES `features` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `feature_property_category_property_category_id_foreign` FOREIGN KEY (`property_category_id`) REFERENCES `property_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `feature_property_category` VALUES (53,17,9,NULL,NULL),(55,18,9,NULL,NULL),(56,19,9,NULL,NULL),(57,20,9,NULL,NULL),(58,21,9,NULL,NULL),(59,21,10,NULL,NULL),(67,24,2,NULL,NULL),(69,17,10,NULL,NULL),(70,17,11,NULL,NULL),(71,25,9,NULL,NULL),(72,25,10,NULL,NULL),(73,25,11,NULL,NULL),(74,26,9,NULL,NULL),(75,26,10,NULL,NULL),(76,26,11,NULL,NULL),(77,19,10,NULL,NULL),(78,19,11,NULL,NULL),(79,20,10,NULL,NULL),(80,20,11,NULL,NULL),(81,18,10,NULL,NULL),(82,18,11,NULL,NULL),(83,21,11,NULL,NULL);
...
INSERT INTO `feature_values` VALUES (112,24,'Ploted','2022-12-01 23:11:15','2022-12-01 23:11:15'),(113,24,'Unplotted','2022-12-01 23:11:15','2022-12-01 23:11:15'),(114,24,'Under Plotting','2022-12-01 23:11:15','2022-12-01 23:11:15'),(155,17,'Un-furnish','2022-12-02 01:26:31','2022-12-02 01:26:31'),(156,17,' Semi-furnish','2022-12-02 01:26:31','2022-12-02 01:26:31'),(157,17,' Fully-furnish','2022-12-02 01:26:31','2022-12-02 01:26:31'),(161,25,'Under construction','2022-12-02 01:30:30','2022-12-02 01:30:30'),(162,25,' Ready to move/Newly built','2022-12-02 01:30:30','2022-12-02 01:30:30'),(163,25,' Already built over 5+ year','2022-12-02 01:30:30','2022-12-02 01:30:30'),(231,26,'1 year','2022-12-21 05:46:09','2022-12-21 05:46:09'),(232,26,' 2 year','2022-12-21 05:46:09','2022-12-21 05:46:09'),(233,26,' 5 year','2022-12-21 05:46:09','
(
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `showOnFilter` enum('0','1') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `features_parent_id_foreign` (`parent_id`),
  CONSTRAINT `features_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `features` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `features` VALUES (17,'Furnishing Type','<p>Furnishing Type</p>',NULL,1,7,NULL,'2022-11-10 05:32:37','2022-12-02 01:50:27','1'),(18,'Parking','<p>this is parking</p>',NULL,1,3,NULL,'2022-11-12 22:51:39','2022-12-02 01:50:27','1'),(19,'Bedroom','<p>this is bed room</p>',NULL,1,1,NULL,'2022-11-12 23:12:06','2022-12-02 01:50:27','1'),(20,'Bathroom','<p>this is bath room.</p>','https://aust.linkedhill.com.np//storage/photos/1/36-362120_deadpool-abstract.jpg',1,2,NULL,'2022-11-12 23:13:24','2022-12-02 01:50:27','1'),(21,'Storeyed','<p>Storeyed</p>','https://aust.linkedhill.com.np//storage/photos/1/2.jpeg',1,4,NULL,'2022-11-23 02:16:46','2022-12-02 01:50:27','1'),(24,'Land/Plot Type','<p>land plotting type</p>',NULL,1,5,NULL,'2022-12-01 23:03:12','2022-12-02 01:50:27','1'),(25,'Building Type','<p>Building Type</p>',NULL,1,6,NULL,'2022-12-02 01:28:41','2022-12-02 01:50:27','0'),(26,'Building Age','<p>Building Age</p>',NULL,1,8,NULL,'2022-12-02 01:50:09','2022-12-02 01:51:21','1');
...
INSERT INTO `model_has_roles` VALUES (1,'App\\Models\\User',1),(1,'App\\Models\\User',43),(1,'App\\Models\\User',44),(1,'App\\Models\\User',45),(2,'App\\Models\\User',2),(3,'App\\Models\\User',3),(3,'App\\Models\\User',40),(3,'App\\Models\\User',41),(3,'App\\Models\\User',51),(3,'App\\Models\\User',53),(3,'App\\Models\\User',54),(3,'App\\Models\\User',56),(3,'App\\Models\\User',57),(3,'App\\Models\\User',58),(3,'App\\Models\\User',59),(3,'App\\Models\\User',60),(3,'App\\Models\\User',61),(3,'App\\Models\\User',62),(3,'App\\Models\\User',63),(3,'App\\Models\\User',64),(3,'App\\Models\\User',65),(3,'App\\Models\\User',66),(3,'App\\Models\\User',67),(3,'App\\Models\\User',68),(3,'App\\Models\\User',69),(3,'App\\Models\\User',70),(3,'App\\Models\\User',71),(3,'App\\Models\\User',72),(3,'App\\Models\\User',73),(3,'App\\Models\\User',74),(3,'App\\Models\\User',75),(3,'App\\Models\\User',76),(3,'App\\Models\\User',77),(3,'App\\Models\\User',78),(3,'App\\Models\\User',79),(3,'App\\Models\\User',80),(3,'App\\Models\\User',81),(3,'App\\Models\\User',82),(3,'App\\Models\\User',83),(3,'App\\Models\\User',84),(3,'App\\Models\\User',85),(3,'App\\Models\\User',86),(3,'App\\Models\\User',87),(3,'App\\Models\\User',88),(3,'App\\Models\\User',89),(3,'App\\Models\\User',90),(3,'App\\Models\\User',91),(3,'App\\Models\\User',92),(3,'App\\Models\\User',115),(3,'App\\Models\\User',116),(3,'App\\Models\\User',117),(3,'App\\Models\\User',118),(3,'App\\Models\\User',119),
"}',NULL,'2022-12-15 23:27:42','2022-12-15 23:27:42'),('3c16187c-00a8-42ab-bd77-967466a18a96','App\\Notifications\\PropertyInquery','App\\Models\\User',150,'{\"notification\":\"{\\\"email\\\":\\\"bemyn@mailinator.com\\\",\\\"name\\\":\\\"Ahmed Hardin\\\",\\\"contact_info\\\":\\\"3656\\\",\\\"subject\\\":\\\"Deleniti qui proiden\\\",\\\"message\\\":\\\"Do earum aspernatur\\\",\\\"property_id\\\":\\\"20\\\",\\\"updated_at\\\":\\\"2022-12-16T06:44:04.000000Z\\\",\\\"created_at\\\":\\\"2022-12-16T06:44:04.000000Z\\\",\\\"id\\\":5}\"}',NULL,'2022-12-16 00:59:11','2022-12-16 00:59:11'),('47e6bbd4-39a4-46af-bce6-57ab83f77e06','App\\Notifications\\PropertyInquery','App\\Models\\User',1,'{\"notification\":\"{\\\"email\\\":\\\"dopucofix@mailinator.com\\\",\\\"name\\\":\\\"Shellie Strickland\\\",\\\"contact_info\\\":\\\"Elit eiusmod omnis\\\",\\\"subject\\\":\\\"Minima neque quasi d\\\",\\\"message\\\":\\\"Aliquip quo sint am\\\",\\\"property_id\\\":\\\"19\\\",\\\"updated_at\\\":\\\"2022-12-16T09:32:20.000000Z\\\",\\\"created_at\\\":\\\"2022-12-16T09:32:20.000000Z\\\",\\\"id\\\":11}\"}',NULL,'2022-12-16 03:47:24','2022-12-16 03:47:24'),('5f2689db-85fa-43dc-bce3-9ca07cc55fd4','App\\Notifications\\PropertyInquery','App\\Models\\User',1,'{\"notification\":\"{\\\"email\\\":\\\"lekhabidhi@gmail.com\\\",\\\"name\\\":\\\"nisc\\\",\\\"contact_info\\\":\\\"9847838183\\\",\\\"subject\\\":\\\"test\\\",\\\"message\\\":\\\"saca\\\",\\\"property_id\\\":\\\"19\\\",\\\"updated_at\\\":\\\"2022-12-21T10:18:09.000000Z\\\",\\\"created_at\\\":\\\"2022-12-21T10:18:09.000000Z\\\",\\\"id\\\":28}\"}',NULL,'2022-12-21 04:33:12','2022-12-21 04:33:12'),('9384d3ab-41a4-4bc1-82d3-6bfc83657227','App\\Notifications\\PropertyInquery','App\\Models\\User',150,'{\"notification\":\"{\\\"email\\\":\\\"voxuzof@mailinator.com\\\",\\\"name\\\":\\\"Ryan Evans\\\",\\\"contact_info\\\":\\\"Velit modi autem rat\\\",\\\"subject\\\":\\\"Ut anim quo nulla al\\\",\\\"message\\\":\\\"Qui illo quisquam au\\\",\\\"property_id\\\":\\\"20\\\",\\\"updated_at\\\":\\\"2022-12-16T05:12:52.000000Z\\\",\\\"created_at\\\":\\\"2022-12-16T05:12:52.000000Z\\\",\\\"id\\\":4}\"}',NULL,'2022-12-15 23:27:55','2022-12-15 23:27:55'),('adf8b721-d566-4e63-b7ac-aaa5d38c34d7','App\\Notifications\\PropertyInquery','App\\Models\\User',1,'{\"notification\":\"{\\\"email\\\":\\\"wunimy@mailinator.com\\\",\\\"name\\\":\\\"Kyra Carey\\\",\\\"contact_info\\\":\\\"Quidem rerum delectu\\\",\\\"subject\\\":\\\"Sit minus aut quas\\\",\\\"message\\\":\\\"Minim qui hic ad und\\\",\\\"property_id\\\":\\\"19\\\",\\\"updated_at\\\":\\\"2022-12-16T09:31:23.000000Z\\\",\\\"created_at\\\":\\\"2022-12-16T09:31:23.000000Z\\\",\\\"id\\\":7}\"}',NULL,'2022-12-16 03:46:27','2022-12-16 03:46:27'),('b41625ed-f02a-4c68-8468-a535868b05f7','App\\Notifications\\PropertyInquery','App\\Models\\User',150,'{\"notification\":\"{\\\"email\\\":\\\"lekhabidhi@gmail.com\\\",\\\"name\\\":\\\"nis sa\\\",\\\"contact_info\\\":\\\"9847838183\\\",\\\"subject\\\":\\\"b\\\",\\\"message\\\":\\\"q\\\",\\\"property_id\\\":\\\"24\\\",\\\"updated_at\\\":\\\"2022-12-21T10:18:46.000000Z\\\",\\\"created_at\\\":\\\"2022-12-21T10:18:46.000000Z\\\",\\\"id\\\":30}\"}',NULL,'2022-12-21 04:33:50','2022-12-21 04:33:50'),('b494d3f6-41a8-4325-9ba1-c84fb4d15b32','App\\Notifications\\PropertyInquery','App\\Models\\User',1,'{\"notification\":\"{\\\"email\\\":\\\"lekhabidhi@gmail.com\\\",\\\"name\\\":\\\"nisc\\\",\\\"contact_info\\\":\\\"9847838183\\\",\\\"subject\\\":\\\"test\\\",\\\"message\\\":\\\"saca\\\",\\\"property_id\\\":\\\"19\\\",\\\"updated_at\\\":\\\"2022-12-21T10:18:02.000000Z\\\",\\\"created_at\\\":\\\"2022-12-21T10:18:02.000000Z\\\",\\\"id\\\":27}\"}',NULL,'2022-12-21 04:33:08','2022-12-21 04:33:08'),('d03734e9-0a86-4f60-a386-05df3ae94562','App\\Notifications\\PropertyInquery','App\\Models\\User',155,'{\"notification\":\"{\\\"email\\\":\\\"lekhabidhi@gmail.com\\\",\\\"name\\\":\\\"nis sa\\\",\\\"contact_info\\\":\\\"9847838183\\\",\\\"subject\\\":\\\"test\\\",\\\"message\\\":\\\"nbjkhbg\\\",\\\"property_id\\\":\\\"21\\\",\\\"updated_at\\\":\\\"2022-12-18T05:00:23.000000Z\\\",\\\"created_at\\\":\\\"2022-12-18T05:00:23.000000Z\\\",\\\"id\\\":26}\"}',NULL,'2022-12-17 23:15:32','2022-12-17 23:15:32'),('fa1eef6e-c8dc-4b59-b567-4ed402acaeb1','App\\Notifications\\PropertyInquery','App\\Models\\User',150,'{\"notification\":\"{\\\"email\\\":\\\"lekhabidhi@gmail.com\\\",\\\"name\\\":\\\"nis sa\\\",\\\"contact_info\\\":\\\"9847838183\\\",\\\"subject\\\":\\\"b\\\",\\\"message\\\":\\\"q\\\",\\\"property_id\\\":\\\"24\\\",\\\"updated_at\\\":\\\"2022-12-21T10:18:43.000000Z\\\",\\\"created_at\\\":\\\"2022-12-21T10:18:43.000000Z\\\",\\\"id\\\":29}\"}',NULL,'2022-12-21 04:33:46','2022-12-21 04:33:46');
...
-15 04:22:42','2022-12-15 04:22:42','2023-12-15 10:07:42'),('a49d4eee9840ddcb82bd38cf8b8a657be901aeeef3ac2d1840f0c69dc8a082aa9a2c4cd8c8fa5e64',150,1,NULL,'[]',0,'2022-12-14 01:12:51','2022-12-14 01:12:51','2023-12-14 06:57:51'),('b516911b94dfba3ad5d56fd806bfef809ad8877ade7f74e813d0a4f11f6ebd6b5a9fa6389f4562a6',150,1,NULL,'[]',0,'2022-12-15 04:39:37','2022-12-15 04:39:37','2023-12-15 10:24:37'),('b818d18426e77a8bafe5aee4838ff6be2a8ab2c8da14eb47fb44b4a91301d309090c9b9113724b54',150,1,NULL,'[]',0,'2022-12-15 04:37:04','2022-12-15 04:37:04','2023-12-15 10:22:04'),('b82567b4e101ec2adf3e1895fa5e872a9587808122e689dabf0c84fb9170a4a2ab653f849e9e9045',39,1,'authToken','[]',0,'2022-11-07 05:15:59','2022-11-07 05:15:59','2023-11-07 11:00:59'),('dd29abf450666e4d7a5c162fe8cbcf4b0544f6565134e89c0f693463b37e0bbcb76964537fda41bf',150,1,NULL,'[]',0,'2022-12-15 04:36:32','2022-12-15 04:36:32','2023-12-15 10:21:32'),('ddbf4b861faebba924fdd7c87188a73f224e63e158288667afb3897e889593ec33ae972cbd81ad79',91,1,'authToken','[]',0,'2022-11-16 01:20:35','2022-11-16 01:20:35','2023-11-16 07:05:35'),('e479e74e59a8d789e26d2cc661b724aed1baf559c053ae3f5162a3c2b48d0c7ae8a54e263d9389f8',150,1,NULL,'[]',0,'2022-12-14 01:13:20','2022-12-14 01:13:20','2023-12-14 06:58:20'),('ee8943c817ea21b76c8c77b0dcab8c0568d9dbb1e003b698b344383daa16a85daff2d5297a76f00b',150,1,NULL,'[]',0,'2022-12-15 04:31:11','2022-12-15 04:31:11','2023-12-15 10:16:11'),('f3bd4ee14017d9310ce4535a60b2da09d8b985a594522ba668fd927dd37c02784b7cbec447c52c8c',150,1,NULL,'[]',0,'2022-12-15 04:23:00','2022-12-15 04:23:00','2023-12-15 10:08:00'),('fe5f70558beb6c453134d09130e662193c8d3986a33c329386fc3d524c4e2069fbf4ab4d350801c4',1,1,'authToken','[]',0,'2022-08-18 07:41:48','2022-08-18 07:41:48','2023-08-18 07:41:48');
...
INSERT INTO `password_resets` VALUES ('rana.bishesh.5@gmail.com','$2y$10$y4cXodLxiJGyscS/J9Ia7emZcWirnakeHCEEFac6CJ6V.ga7CAmIK','2022-11-14 01:49:05'),('bishesh.nectar@gmail.com','$2y$10$HCloWngQHbWiZ84FwxV8Yuymt/dY4CGylBbeoyE/ZMVy/6dqObViW','2022-11-14 02:09:11');
...
CREATE TABLE `properties` (
  ...
  `property_status` varchar(191) DEFAULT NULL,
  `type` varchar(191) DEFAULT NULL,
  `title` varchar(191) DEFAULT NULL,
  `order` int(11) DEFAULT NULL,
  `slug` varchar(191) DEFAULT NULL,
  `property_detail` text DEFAULT NULL,
  `property_address` varchar(191) DEFAULT NULL,
  ...
  `total_area_unit` varchar(191) DEFAULT NULL,
  `built_up_area` varchar(191) DEFAULT NULL,
  `built_up_area_unit` varchar(191) DEFAULT NULL,
  `property_facing` varchar(191) DEFAULT NULL,
  `road_width` int(11) DEFAULT NULL,
  `road_width_unit` varchar(191) DEFAULT NULL,
  `road_access` varchar(191) DEFAULT NULL,
  `road_access_unit` varchar(191) DEFAULT NULL,
  `road_type` varchar(191) DEFAULT NULL,
  `start_price` decimal(11,2) NOT NULL DEFAULT 0.00,
  `end_price` decimal(11,2) NOT NULL DEFAULT 0.00,
  `price_label` varchar(191) DEFAULT NULL,
  `owner_name` varchar(191) DEFAULT NULL,
  `owner_address` varchar(191) DEFAULT NULL,
  ...
  CONSTRAINT `properties_category_id_foreign` FOREIGN KEY (`category_id`) REFERENCES `property_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `properties` VALUES (2,1,'Rent','land','land on sell',2,'land-on-sell','<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover&nbsp;</p>','Lalitpur',NULL,1,0,0,1,'48687','55','1','45','1','South',22,'1','22','1','2',7500000.00,0.00,'Total','Noelle Landry','Barbara','9812345678','eee@gmail.com',NULL,0,0,0,1,NULL,2,59,0,0,1,'2022-12-02 02:04:52','2022-12-02 04:01:45','2022-08-18 07:37:46','2022-12-02 04:01:45',NULL,NULL),(5,1,'Rent','Residential','Royal Hotel',1,'royal-hotel','<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>','Lalitpur',NULL,1,6,6,1,'48687','22','1','44','1','South',45,'1','45','1','2',85000000.00,0.00,'Total','Noelle Landry','Barbara','9812345678','eee@gmail.com','V00TZgYN-jc',1,1,1,1,NULL,9,69,0,0,1,'2022-12-02 06:05:11','2022-12-03 23:35:35','2022-08-18 07:59:15','2022-12-03 23:35:35',NULL,NULL),(8,0,'Rent','Residential','bisehsh house',4,'bisehsh-house','<p>asfdsafsa</p>','asfdsf',NULL,1,5,3,1,'44600','3234','1','324','1','South',NULL,NULL,'23','1','2',500000.00,0.00,'Per Month','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',1,1,0,1,NULL,9,2,0,0,1,'2022-11-16 05:18:59','2022-12-02 04:01:50','2022-11-08 04:12:17','2022-12-02 04:01:50',NULL,NULL),(9,0,'Rent','Residential','subuz property',NULL,'subuz-property','<p>safsaf</p>','sadfsdf',NULL,1,4,4,1,'44600','12','1','11','1','East',NULL,NULL,'32','1','1',500000.00,0.00,'Per Month','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',1,1,0,1,NULL,9,1,0,0,1,'2022-11-10 05:17:29','2022-11-10 05:26:58','2022-11-08 04:14:05','2022-11-10 05:26:58',NULL,NULL),(10,0,'Rent','Residential','house',5,'house','<p>this is best</p>','machapokhari',NULL,1,0,0,1,'44600','12','1','11','1','South',32,'1','32','1','2',50000.00,0.00,'Total','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',0,0,0,1,NULL,9,3,0,0,1,'2022-11-22 06:18:46','2022-12-02 04:01:54','2022-11-10 00:28:12','2022-12-02 04:01:54',NULL,NULL),(11,0,'Rent','Residential','test',NULL,'test','<p>safdsfs</p>','machapokhari',NULL,1,0,0,1,'44600','12','1','11','1','South',NULL,NULL,'32','1','1',50000.00,0.00,'Per Month','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',1,0,0,1,NULL,9,1,0,0,1,'2022-11-10 02:20:55','2022-11-10 05:25:35','2022-11-10 02:20:55','2022-11-10 05:25:35',NULL,NULL),(12,0,'Rent','Residential','test2',NULL,'test2','<p>sfdsf</p>','machapokhari',NULL,1,0,0,1,'44600','12','1','11','1','South',NULL,NULL,'32','1','1',50000.00,0.00,'Per Month','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',1,0,0,1,NULL,9,1,0,0,1,'2022-11-10 02:32:59','2022-11-10 05:25:30','2022-11-10 02:32:59','2022-11-10 05:25:30',NULL,NULL),(13,0,'Rent','Residential','Bishesh',NULL,'bishesh','<p>asfsfss</p>','machapokhari',NULL,1,0,0,1,'44600','12','1','11','1','South',NULL,NULL,'32','1','1',50000.00,0.00,'Per Month','Bishesh Rana','bypass','9846803262',NULL,'youtube.com',0,0,0,1,NULL,9,1,0,0,1,'2022-11-10 05:21:16','2022-11-10 05:24:11','2022-11-10 05:14:37','2022-11-10 05:24:11',NULL,NULL),(17,1,'Rent','Residential','Agent Apartment',1,'agent-apartment','<p>this is agent apartment</p>','balaju',NULL,1,0,0,1,'44600','12','2','11','2','South',32,'1','32','1','2',50000.00,0.00,'Total','Bishesh Rana','bypass','9846803262','bishesh.nectar@gmail.com','youtube.com',0,0,0,1,NULL,9,4,0,0,1,'2022-12-02 01:08:22','2022-12-02 04:01:57','2022-11-16 04:37:40','2022-12-02 04:01:57',NULL,NULL),(18,1,'Buy','Residential','test on sale',NULL,'test-on-sale','<p>test on sale</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','5','5','5','South',NULL,NULL,'6','2','2',10000000.00,0.00,'Total','nis sa','ktm','98908',NULL,'iTs1lnqN1wY',1,1,1,1,NULL,9,7,0,0,1,'2022-12-01 22:57:51','2022-12-02 04:01:41','2022-12-01 22:57:51','2022-12-02 04:01:41',NULL,NULL),(19,1,'Rent',NULL,'Home for sale',NULL,'home-for-sale','<p>Home for sale</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','5','5','5','South',12,'2','12','4','2',16000000.00,0.00,'Total','nis sa','ktm','98908','eee@gmail.com',NULL,1,1,0,1,NULL,9,35,0,0,1,'2022-12-21 03:39:23',NULL,'2022-12-03 23:37:45','2023-01-15 10:38:41',NULL,NULL),(20,0,'Buy','Residential','added by agent',NULL,'added-by-agent','<p>this propertu is added by agent</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','5','5','5','South',45,'1','45','1','2',16000000.00,0.00,'Total','nis sa','ktm','98908','eee@gmail.com',NULL,1,1,0,1,NULL,11,18,0,0,1,'2022-12-21 02:06:15',NULL,'2022-12-14 00:59:23','2022-12-23 04:41:11',NULL,NULL),(21,0,'Rent','Residential','townhouse on sale',NULL,'townhouse-on-sale','<p>townhouse on sale&nbsp;</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','5','5','5','South',NULL,NULL,'25','2','2',250000.00,0.00,'Total','nischal','ktm','9810074102',NULL,NULL,1,1,1,155,NULL,11,4,0,0,NULL,NULL,NULL,'2022-12-17 22:58:00','2022-12-23 04:41:07',NULL,NULL),(22,0,'Rent','Residential','added by staff',NULL,'added-by-staff','<p>bb</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','5','5','5','South',25,'1','25','1','2',2500000.00,0.00,'Total','nis sa','ktm','98908','eee@gmail.com',NULL,1,1,1,150,NULL,10,20,0,1,NULL,NULL,NULL,'2022-12-21 01:48:32','2022-12-23 04:41:15',NULL,NULL),(24,0,'Rent','Residential','added by staff on agent',NULL,'added-by-staff-on-agent','<p>sadcf</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','1','5','1','South',14,'1','14','1','2',25000.00,0.00,'Total','nis sa','ktm','98908','eee@gmail.com',NULL,1,1,0,150,NULL,10,8,0,1,NULL,NULL,NULL,'2022-12-21 02:31:24','2022-12-23 04:41:17',NULL,NULL),(25,0,'Rent','Residential','builder\'s property',NULL,'builders-property','<p>builder\'s property</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','1','5','1','South',NULL,NULL,'45','1','2',25000.00,0.00,'Total','nis sa','ktm','98908',NULL,NULL,1,1,0,172,NULL,10,3,0,1,NULL,NULL,NULL,'2022-12-22 01:53:44','2022-12-23 04:41:22',NULL,NULL),(26,0,'Rent','Residential','added by admin for user',NULL,'added-by-admin-for-user','<p>added by admin for user</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','1','5','1','South',45,'1','45','1','2',25000.00,0.00,'Total','nis sa','ktm','98908','eee@gmail.com',NULL,1,1,1,150,NULL,9,6,0,1,NULL,NULL,NULL,'2022-12-22 04:23:18','2022-12-23 04:41:48',NULL,NULL),(27,0,'Buy','Residential','b',NULL,'b','<p>asdc</p>','balaju,kathmandu',NULL,1,0,0,1,'45885','6','1','5','1','South',NULL,NULL,'45','1','2',25000.00,0.00,'Total','nis sa','ktm','98908',NULL,NULL,1,1,0,150,NULL,10,4,0,1,NULL,NULL,NULL,'2022-12-22 04:48:46','2022-12-29 01:12:30',NULL,NULL);
...
INSERT INTO `property_categories` VALUES (2,NULL,'Land','https://aust.linkedhill.com.np//storage/photos/1/1660115945photo-1500382017468-9049fed747ef.jpg','https://source.unsplash.com/sYffw0LNr7s',2,NULL,'land',NULL,'2022-12-23 04:19:58'),(9,NULL,'House','https://aust.linkedhill.com.np//storage/photos/1/house.jpg','https://aust.linkedhill.com.np//storage/photos/1/house.jpg',1,NULL,'house','2022-11-10 00:10:46','2022-12-23 04:24:12'),(10,NULL,'Apartment/Flat','https://aust.linkedhill.com.np//storage/photos/1/apartment.jpg','https://aust.linkedhill.com.np//storage/photos/1/apartment.jpg',3,NULL,'apartmentflat','2022-11-18 05:48:47','2022-12-23 04:20:25'),(11,NULL,'Townhouse/Villa/Duplex','https://aust.linkedhill.com.np//storage/photos/1/2.jpeg','https://aust.linkedhill.com.np//storage/photos/1/2.jpeg',NULL,NULL,'townhousevilladuplex','2022-11-29 01:31:52','2022-12-01 03:57:13');
...
CREATE TABLE `property_facilities` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY
...
INSERT INTO `property_faqs` VALUES (1,'faq question','faq answer',1,20,NULL,'2022-12-14 00:59:46','2022-12-14 00:59:46'),(2,'price','negotiable(as per trending price nearby)',1,21,NULL,'2022-12-17 23:03:44','2022-12-17 23:03:44');
...
INSERT INTO `property_images` VALUES (2,'https://www.linkedhill.com.np/images/property/1660808266Land-plots-prepared-for-sale.jpg',1,2,'2022-08-18 07:37:46','2022-08-18 07:37:46',NULL),(5,'https://www.linkedhill.com.np/images/property/1660809555shangrila-village-resort.jpg',1,5,'2022-08-18 07:59:15','2022-08-18 07:59:15',NULL),(8,'https://aust.linkedhill.com.np//images/property/1667901437download.jpg',1,8,'2022-11-08 04:12:17','2022-11-08 04:12:17',NULL),(10,'https://aust.linkedhill.com.np//images/property/16680607927-77347_deadpool-high-definition-wallpaper-ultra-hd-deadpool-wallpaper.jpg',1,10,'2022-11-10 00:28:12','2022-11-10 00:28:12',NULL),(11,'https://aust.linkedhill.com.np//images/property/166806755536-362120_deadpool-abstract.jpg',1,11,'2022-11-10 02:20:55','2022-11-10 02:20:55',NULL),(12,'https://aust.linkedhill.com.np//images/property/16680682791131759.jpg',1,12,'2022-11-10 02:32:59','2022-11-10 02:32:59',NULL),(13,'https://aust.linkedhill.com.np//images/property/16680779771131759.jpg',1,13,'2022-11-10 05:14:37','2022-11-10 05:14:37',NULL),(14,'https://aust.linkedhill.com.np//images/property/1669099566_MG_8226.jpg',1,17,'2022-11-22 01:01:06','2022-11-22 01:01:06',NULL),(15,'https://aust.linkedhill.com.np//images/property/1669956171product1596096586.png',1,18,'2022-12-01 22:57:51','2022-12-01 22:57:51',NULL),(16,'https://aust.linkedhill.com.np//images/property/1669956171product1596096098.jpeg',1,18,'2022-12-01 22:57:51','2022-12-01 22:57:51',NULL),(17,'https://aust.linkedhill.com.np//images/property/1669956171product1596096710.jpeg',1,18,'2022-12-01 22:57:51','2022-12-01 22:57:51',NULL),(18,'https://aust.linkedhill.com.np//images/property/1669956171product1596097413.png',1,18,'2022-12-01 22:57:51','2022-12-01 22:57:51',NULL),(19,'https://aust.linkedhill.com.np//images/property/16699811891644228134a3.jpg',1,5,'2022-12-02 05:54:49','2022-12-02 05:54:49',NULL),(20,'https://aust.linkedhill.com.np//images/property/16699811891644228134a4.jpg',1,5,'2022-12-02 05:54:49','2022-12-02 05:54:49',NULL),(21,'https://aust.linkedhill.com.np//images/property/16701313651652853655grant-N90LM3A5AZQ-unsplash(1).jpg',1,19,'2022-12-03 23:37:45','2022-12-03 23:37:45',NULL),(22,'https://aust.linkedhill.com.np//images/property/16701313651652853706sandra-frey-Fcdfodl29k0-unsplash.jpg',1,19,'2022-12-03 23:37:45','2022-12-03 23:37:45',NULL),(23,'https://aust.linkedhill.com.np//images/property/16701313651652853733super-panel-NXBFQdWR_c8-unsplash.jpg',1,19,'2022-12-03 23:37:45','2022-12-03 23:37:45',NULL),(24,'https://aust.linkedhill.com.np//images/property/16701313651653197478Winning is not everything but effort to win is..jpg',1,19,'2022-12-03 23:37:45','2022-12-03 23:37:45',NULL),(25,'https://aust.linkedhill.com.np//images/property/1671000263product1596096098.jpeg',150,20,'2022-12-14 00:59:23','2022-12-14 00:59:23',NULL),(26,'https://aust.linkedhill.com.np//images/property/1671338580logo.png',155,21,'2022-12-17 22:58:00','2022-12-17 22:58:00',NULL),(27,'https://aust.linkedhill.com.np//images/property/1671608012aarati.png',178,22,'2022-12-21 01:48:32','2022-12-21 01:48:32',NULL),(28,'https://aust.linkedhill.com.np//images/property/1671610584Inverted (1).png',178,24,'2022-12-21 02:31:24','2022-12-21 02:31:24',NULL),(29,'https://aust.linkedhill.com.np//images/property/1671694724shutterstock_1566843154.jpg',172,25,'2022-12-22 01:53:44','2022-12-22 01:53:44',NULL),(30,'https://aust.linkedhill.com.np//images/property/1671703698shutterstock_1566843154.jpg',1,26,'2022-12-22 04:23:18','2022-12-22 04:23:18',NULL),(31,'https://aust.linkedhill.com.np//images/property/1671705226types-of-homes-hero.jpg',178,27,'2022-12-22 04:48:46','2022-12-22 04:48:46',NULL);
...
DROP TABLE IF EXISTS `purchase_properties`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `purchase_properties` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `purchase_properties_user_id_foreign` (`user_id`),
  KEY `purchase_properties_property_id_foreign` (`property_id`),
  CONSTRAINT `purchase_properties_property_id_foreign` FOREIGN KEY (`property_id`) REFERENCES `properties` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `purchase_properties_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `purchase_properties`
--

LOCK TABLES `purchase_properties` WRITE;
/*!40000 ALTER TABLE `purchase_properties` DISABLE KEYS */;
/*!40000 ALTER TABLE `purchase_properties` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `purposes` VALUES (1,NULL,'Buy',1,NULL,'2022-11-29 05:16:24'),(2,NULL,'Rent',2,NULL,'2022-11-29 05:16:24');
...
CREATE TABLE `questions` (
  ...
  `isParent` enum('1','0') NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `road_types` VALUES (2,'Pitched',NULL,'2022-12-02 01:37:11'),(3,'Gravelled',NULL,'2022-12-02 01:39:11'),(4,'Soil Stabilized','2022-12-02 01:39:20','2022-12-02 01:39:20'),(5,'No Road Access','2022-12-02 01:39:52','2022-12-02 01:39:52'),(6,'Other','2022-12-21 05:42:58','2022-12-21 05:42:58');
...
INSERT INTO `role_has_permissions` VALUES (1,3),(2,3),(3,3),(4,3),(49,3),(49,5),(50,3),(50,5),(51,3),(51,5),(52,3),(52,5),(126,3),(127,3),(128,3),(129,3),(140,3),(141,3),(141,5);
...
INSERT INTO `roles` VALUES (1,'Super Admin','web',NULL,NULL,NULL),(2,'Admin','web',NULL,NULL,NULL),(3,'Agent','web',NULL,NULL,NULL),(4,'Builder','web',NULL,NULL,NULL),(5,'Customer','web',NULL,NULL,NULL);
...
INSERT INTO `sliders` VALUES (1,'Slider First','https://aust.linkedhill.com.np//storage/photos/1/1660115945photo-1500382017468-9049fed747ef.jpg','https://linkedhill.com/',1,1,50,NULL,NULL,'2022-12-23 04:18:53'),(2,'Slider Second','https://source.unsplash.com/Bkp3gLygyeA','https://linkedhill.com/',1,1,50,'2022-09-26 11:34:34',NULL,'2022-09-26 11:34:34'),(3,'Slider Third','https://source.unsplash.com/xQWLtlQb7L0','https://linkedhill.com/',1,1,50,NULL,NULL,NULL),(4,'Slider','https://aust.linkedhill.com.np/storage/photos/1/brown-and-gray-painted-house-in-front-of-road-1396122.jpg',NULL,0,1,50,NULL,'2022-09-26 06:10:48','2022-09-26 06:10:48'),(5,'Slider','https://aust.linkedhill.com.np/storage/photos/1/brown-and-gray-painted-house-in-front-of-road-1396122.jpg',NULL,0,1,50,'2022-09-26 11:35:14','2022-09-26 06:12:56','2022-09-26 11:35:14');
...
INSERT INTO `subscribers` VALUES (1,'lekhabidhi@gmail.com','2022-12-23 04:35:40','2022-12-23 04:35:40');
...
CREATE TABLE `teams` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(191) NOT NULL,
  `profile` varchar(191) NOT NULL DEFAULT 'team.png',
...
CREATE TABLE `tradelink_books` (
  ...
  `user_id` bigint(20) unsigned DEFAULT NULL,
  `status` enum('completed','cancelled','pending','progress') NOT NULL DEFAULT 'pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `tradelink_websites` (
  ...
  `copyright_message` varchar(100) NOT NULL,
...
INSERT INTO `units` VALUES (1,'Haath',2,NULL,'2022-11-22 00:11:26'),(2,'Kathhaa',1,NULL,'2022-11-22 00:11:26'),(3,'Bigah',3,NULL,'2022-11-22 00:11:26'),(4,'Daam',4,NULL,'2022-11-22 00:11:26'),(5,'Aana',5,NULL,'2022-11-22 00:11:26'),(6,'Paisa',6,NULL,'2022-11-22 00:11:26'),(7,'Ropani',7,NULL,'2022-11-22 00:11:26'),(8,'Sq. Ft',8,NULL,'2022-11-22 00:11:26'),(9,'Sq. M',9,NULL,'2022-11-22 00:11:26'),(10,'Acres',10,NULL,'2022-11-22 00:11:26');
...
CREATE TABLE `users` (
  ...
  `mobile` varchar(191) DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
  `testP` varchar(191) DEFAULT NULL,
  `dob` varchar(191) DEFAULT NULL,
  `full_address` date DEFAULT NULL,
  `access_token` text DEFAULT NULL,
  `is_blocked` tinyint(1) NOT NULL DEFAULT 0,
  `block_remark` varchar(191) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  `social_id` varchar(191) DEFAULT NULL,
  `social_from` enum('facebook','google','normal') NOT NULL DEFAULT 'normal',
  `email_verified_at` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `users_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
INSERT INTO `users` VALUES (1,'nectardigit','https://aust.linkedhill.com.np//storage/photos/1/download.png','nectardigit@gmail.com','$2a$12$bRTdQpxMdqq2XyOJ7CxzceJKDjJrdGGyYl/aI.crYxHf4.qhXUd.O',NULL,NULL,'98022',NULL,'https://aust.linkedhill.com.np//storage/photos/1/download.png',NULL,NULL,NULL,'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..IRrp0qCk7wBO8qJuz7IR_jJcnPqkk3GHr1qxtheVZJzQP0gKhZ3MqixOozzLO_Jwh_LGEFUEwzYDd3Vdj_ctnyEnYwHHttqIMzTQ7bZqPh_cLEqmuIK8r1eJMM2Cwh7TaSG9gTA2WI_lVdDc7ujjywajtVzmlxEuQ6kVRlC83adLDFKckQzW7q6sykvCDFoqa0Ia5uInffERpfc6-LRKR3Cxizv4Twmpxz
ULL,NULL,'9811565656',NULL,NULL,NULL,NULL,NULL,0,NULL,0,NULL,'normal',NULL,NULL,'QwNAUfHn',0.00,NULL,NULL,'2022-12-20 05:16:05','2022-12-21 04:41:03','2022-12-21 04:41:03',172),(176,'nis ko staff',NULL,'nectardigitnis@gmail.com','$2y$10$p.jZa7lh/Jav5SG2s4zBTeCTGicMahBVzH1wtVgPp2HW6prH01vZ2',NULL,NULL,'1231231233','9847838199',NULL,NULL,NULL,NULL,NULL,0,NULL,1,NULL,'normal',NULL,NULL,'Qohu0Z8o',0.00,NULL,NULL,'2022-12-20 23:43:51','2022-12-21 04:40:52','2022-12-21 04:40:52',158),(177,'Robin Burks',NULL,'dufi@mailinator.com','$2y$10$Pzt.V20mVbYo7OHxuT3ySeK52oJzjWqcdYsk3ECUErM9pyYIEHKHO',NULL,NULL,'12345675895','9874561235',NULL,NULL,NULL,NULL,NULL,0,NULL,1,NULL,'normal','2022-12-21 00:03:08',NULL,'lLOqESC4',0.00,NULL,NULL,'2022-12-21 00:03:08','2022-12-21 04:40:46','2022-12-21 04:40:46',159),(178,'nischal\' staff',NULL,'nischal_staff@gmail.com','$2y$10$rIMNKc0v7YxaBbzWPZGIVuUjPmxc93WMXBWA2RXPpqB4svZ9f.3Jy',NULL,NULL,NULL,'9847838000',NULL,NULL,NULL,NULL,NULL,0,NULL,1,NULL,'normal','2022-12-21 00:04:15',NULL,'vF8Tie2x',0.00,NULL,NULL,'2022-12-21 00:04:15','2022-12-21 00:48:26',NULL,150),(179,'i agent',NULL,'indiagent@gmail.com','$2y$10$1vY4xeLzA.FxdrOGUuljVeD6F3QIUhkLvJqfoLW9E0kQkjrp1Oko.',NULL,NULL,'1231231233','9810083818',NULL,NULL,NULL,NULL,NULL,0,'s',1,NULL,'normal','2022-12-22 03:41:24','207014','bOEQFXQD',0.00,NULL,NULL,'2022-12-21 05:16:31','2022-12-22 03:41:33',NULL,NULL),(180,'added staff by admin',NULL,'gg@gmail.com','$2y$10$glvZ8CCi7D64yo7E0Xv9IO1vXmX37hwanF4fK2OacXEWVURNjswB.',NULL,NULL,'1231231233','9847000000',NULL,NULL,NULL,NULL,NULL,0,NULL,1,NULL,'normal','2022-12-22 02:05:01',NULL,'y9UibNCj',0.00,NULL,NULL,'2022-12-22 02:05:01','2022-12-22 02:05:01',NULL,150);
...
CREATE TABLE `websites` (
  ...
  `name` varchar(191) NOT NULL,
  `logo` varchar(200) DEFAULT NULL,
  `logo_footer` varchar(200) DEFAULT NULL,
  ...
  `playstore_url` varchar(191) DEFAULT NULL,
  `appstore_url` varchar(191) DEFAULT NULL,
  `short_intro` varchar(191) DEFAULT NULL,
  ...
  `pro_title` varchar(191) DEFAULT NULL,
  `pro_sub_title` mediumtext DEFAULT NULL,
  `second_pro_title` varchar(191) DEFAULT NULL,
  `second_pro_sub_title` mediumtext DEFAULT NULL,
  `blog_title` varchar(191) DEFAULT NULL,
  `blog_sub_title` mediumtext DEFAULT NULL,
  `login_title` varchar(191) DEFAULT NULL,
  `login_sub_title` mediumtext DEFAULT NULL,
  `second_login_sub_title` mediumtext DEFAULT NULL,
  `third_login_sub_title` mediumtext DEFAULT NULL,
  `four_login_sub_title` mediumtext DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2023-01-23  7:08:21
