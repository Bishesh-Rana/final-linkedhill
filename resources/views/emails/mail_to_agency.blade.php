...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        .gradient { background: linear-gradient(to right, #3F8809 0%,#3F8809 100%); }

        .btn-secondary { border-radius: 10px; background: linear-gradient(to right, #3F8809 0%,#3F8809 100%); }
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        <td class="img-center p-30 px-15" style="font-size:0pt; line-height:0pt; text-align:center; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                                                            <a href="#" target="_blank"><img src="{{asset('images/'.$website->logo)}}" width="60%" height="60%" border="0" alt="" /></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!-- Logo -->
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>Agency Account Created</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px;  padding-bottom: 25px;">
                                                                                                    Linkedhill have successfully created your account.
                                                                                                    <br>
                                                                                                    You  now post your property and manage your account using below cedential .
                                                                                                    <br>
                                                                                                    <b> Email : {{$user->email}}</b>
                                                                                                    <br>
                                                                                                    <b> Password : {{$user->testP}}</b>
                                                                                                    <br>
                                                                                                    Thankyou for joining Linkedhill.
                                                                                                    ...
                                                                                                    <table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
                                                                                                        <tr>
                                                                                                            <td class="btn-16 c-white l-white" bgcolor="#3F8809;" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                                <a href="https://linkedhill.com/" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                    <span class="link c-white" style="text-decoration:none; color:#ffffff;">Login To Your Account</span>
                                                                                                                </a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <tr>
                                                                        @if($website->fb_url != null)
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="{{$website->fb_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_facebook.png" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                        @endif
                                                                        @if($website->instagram_url != null)
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="{{$website->instagram_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_instagram.png" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                        @endif
                                                                        @if($website->twitter_url != null)
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="34" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="{{$website->twitter_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/ico_twitter.png" width="34" height="34" border="0" alt="" /></a>
                                                                            </td>
                                                                        @endif
                                                        ...
                                                        <tr>
                                                            <td class="text-14 lh-24 a-center c-white l-white pb-20" style="font-size:14px; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 24px; text-align:center; color:#ffffff; padding-bottom: 20px;">
                                                                ...
                                                                @endif
                                                                <br />
                                                                <a href="tel:{{$website->phone}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{$website->phone}}</span></a>                                                               <br />
                                                                <a href="mailto:{{$website->email}}" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">{{$website->email}}</span></a> - <a href="https://linkedhill.com/" target="_blank" class="link c-white" style="text-decoration:none; color:#ffffff;"><span class="link c-white" style="text-decoration:none; color:#ffffff;">www.linkedhill.com</span></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="0">
                                                                    <tr>
                                                                        @if($website->appstore_url != null)
                                                                            <td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="{{$website->appstore_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/btn_appstore.png" width="117" height="40" border="0" alt="" /></a>
                                                                            </td>
                                                                        @endif
                                                                        @if($website->playstore_url != null)
                                                                            <td class="img" width="15" style="font-size:0pt; line-height:0pt; text-align:left;"></td>
                                                                            <td class="img" width="117" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                                <a href="{{$website->playstore_url}}" target="_blank"><img src="https://www.psd2newsletters.com/templates/purple/images/btn_gplay.png" width="117" height="40" border="0" alt="" /></a>
                                                                            </td>
                                                                        @endif
                                                                    </tr>
                                                                </table>
