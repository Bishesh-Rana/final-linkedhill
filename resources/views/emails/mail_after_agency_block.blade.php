                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="title-36 a-center pb-15" style="font-size:36px; line-height:40px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center; padding-bottom: 15px;">
                                                                                                    <strong>Agency Account Blocked</strong>
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td class="text-16 lh-26 a-center pb-25" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px;  padding-bottom: 25px;">
                                                                                                    You account has been bloked.Please contact {{$website->email}} for futher information or you can call us at {{$website->phone}}.
                                                                                                    <br>
                                                                                                    <b> Password : {{$user->block_remark}}</b>
                                                                                                    <br><br>
                                                                                                    Thankyou.
                                                                                                    <br>
                                                                                                    Linkedhill
                                                                                                    ...
                                                                                                    www.linkedhill.com
                                                                                                    <br>
                                                                                                    {{$website->email}},{{$website->alternate_email}}
                                                                                                    <br>
                                                                                                    {{$website->address}}
                                                                                                    <br>
                                                                                                    {{$website->phone}}
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td class="btn-16 c-white l-white" bgcolor="#3F8809;" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                                                                                                <a href="https://linkedhill.com/" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                    <span class="link c-white" style="text-decoration:none; color:#ffffff;">Linkedhill</span>
                                                                                                                </a>
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                    </table>
