        ...
        <div class="row">
            <div class="col-md-5">
                <div class="card">
                    <div class="card-header card-header-tabs" data-background-color="red">
                        <div class="nav-tabs-navigation">
                            <div class="nav-tabs-wrapper">
                                <span class="nav-tabs-title">Property Type:</span>
                                <ul class="nav nav-tabs" data-tabs="tabs">
                                    <li class="active">
                                        <a href="#panel1" data-toggle="tab" aria-expanded="false">
                                            <i class="material-icons">add</i>Create Property Type
                    ...
                    <form action="{{route('type.store')}}"  method="post" enctype="multipart/form-data" id="parsleyValidationForm" data-parsley-validate="">
                        @csrf
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="panel1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="title" class="form-control" data-parsley-trigger="keyup"  required>
                                        @if ($errors->has('name'))
                        ...
                        <div class="nav-tabs-navigation">
                            <div class="nav-tabs-wrapper">
                                ...
                                <ul class="nav nav-tabs" data-tabs="tabs">
                                    <li class="active">
                                        <a href="#panel1" data-toggle="tab" aria-expanded="false">
                                            <i class="material-icons">add</i>Manage Property Types
                                            <div class="ripple-container"></div>
                                        </a>
                                    </li>
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        @foreach($types as $type)
                                            <tr>
                                                ...
                                                <td>{{$type->name}}</td>
                                                <td class="text-right">
                                                    <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#exampleModal-{{$type->id}}" data-placement="top" title="Edit Property Type"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    ...
                    <form action="{{route('type.update',$type->id)}}" method="post">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><b>Edit Property Type</b></h5>
                                <hr>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group  label-floating">
                                        <label>
                                            Enter Property Type Slug
                                            {{--<small>*</small>--}}
                                        </label>
                                        <input class="form-control" name="slug" value="{{$type->slug}}" type="text" required />
                                    </div>
                                </div>
