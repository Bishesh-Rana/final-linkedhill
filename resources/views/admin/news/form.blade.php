                                ...
                                <ul class="nav nav-tabs" data-tabs="tabs">
                                    <li class="active">
                                        <a href="#panel1" data-toggle="tab" aria-expanded="false">
                                            <i class="material-icons">settings</i>Edit News
                            ...
                            <div class="tab-pane active" id="panel1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group  label-floating">
                                        ...
                                        <input class="form-control" name="title" value="{{ $news->title }}" id="title"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group  label-floating">
                                        ...
                                        <input class="form-control" name="slug" value="{{ $news->slug }}" id="slug"
                                            type="text" data-parsley-trigger="keyup" required />
                                        @if ($errors->has('slug'))
                                            <span class="error-message">
                                                *{{ $errors->first('slug') }}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote" name="description"
                                            data-parsley-trigger="keyup">{{ $news->description }}</textarea>
                                        ...
                                        <div class="togglebutton">
                                            <label class="lead"
                                                ...
                                                Non Featured <input type="checkbox" name="feature" value="1"
                                                    @if ($news->featured) checked @endif> Featured
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row seo">
                                    <div class="form-group margin-style col-md-12">
                                        ...
                                        <textarea name="meta_keyword" id="" cols="30" rows="3" class="form-control"
                                            ...
                                            data-parsley-maxlength="300">{{ $news->meta_keyword }}</textarea>
                                    ...
                                    <div class="form-group margin-style col-md-12" style="margin-top: 20px">
                                        ...
                                        <textarea name="meta_description" id="" cols="30" rows="3" class="form-control"
                                            data-parsley-trigger="keyup"
                                            data-parsley-maxlength="300">{{ $news->meta_description }}</textarea>
