                            ...
                            <ul class="nav nav-tabs" data-tabs="tabs">
                                <li class="active">
                                    <a href="#panel1" data-toggle="tab" aria-expanded="false">
                                        <i class="material-icons">settings</i>Manage News Categories
                                        <div class="ripple-container"></div>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="{{route('news-category.create')}}" aria-expanded="false">
                                        <i class="material-icons">add</i>Add News Category
                                        <div class="ripple-container"></div>
                                    </a>
                                </li>
                            </ul>
                                ...
                                <table id="datatables" class="table table-striped table-no-bordered table-hover"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$category->name}}</td>
                                            <td><a href="{{route('news-category.subcategory',$category->id)}}"
                                                    rel="tooltip" data-original-title="View Subcategories"><span
                                                        class="material-icons">list_alt</span><sub>({{count($category->children)}})</sub></a>
                                            </td>
                                            <td class="text-right">
                                                <a href="{{route('news-category.edit',$category->id)}}"
                                                    class="btn btn-xs btn-primary" data-placement="top"
                                                    title="Edit Category"><i class="fa fa-pencil-square-o"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group  label-floating">
                                ...
                                <input class="form-control" name="slug" id="name" value="{{$category->slug}}"
                                    type="text" required />
                            </div>
                        </div>
                                ...
                                <div class="togglebutton">
                                    <label class="lead" style="color:black;font-weight:bold;font-size:11pt;">
                                        Non Featured <input type="checkbox" name="feature" value="1"
                                            @if($category->feature) checked @endif> Featured
                                    </label>
                                </div>
                            </div>
                        </div>
