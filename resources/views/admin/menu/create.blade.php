                        ...
                        <form action="{{route('menu.store')}}"  method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group  label-floating">
                                    ...
                                    <input class="form-control" name="name" value="{{old('name')}}"  type="text"  id="title" />
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-6">
                                <div class="form-group  label-floating">
                                    ...
                                    <input class="form-control" name="slug" value="{{old('slug')}}" id="slug" type="text"  />
                                    @if ($errors->has('slug'))
                                        <span class="error-message">
                                                                 *{{ $errors->first('slug') }}
                                                         </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group  label-floating">
                                    ...
                                    <input class="form-control" name="order" value="{{old('order')}}" id="slug" type="number"  />
                                    @if ($errors->has('order'))
                                        <span class="error-message">
                                                                 *{{ $errors->first('order') }}
                                                         </span>
                                ...
                                <div class="form-group">
                                    <div class="togglebutton">
                                        <label class="lead" style="color:black;font-weight:bold;font-size:11pt; margin: 20px 0px" >
                                            Hide <input type="checkbox" name="active"  value="1" checked> Show
                                        </label>
                                    </div>
                                </div>
                            </div>
