                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        @foreach($blogs as $blog)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-md-1">
                                                        <a href="{{route('blog.edit',$blog->id)}}" class="btn btn-simple btn-warning btn-icon edit" rel="tooltip"  data-original-title="Edit Blog"><i class="material-icons">edit</i></a>
                                                    </div>
                                                    <div class="col-md-1"></div>
                                                    <div class="col-md-1">
                                                        <a href="#"  class="btn btn-simple btn-danger btn-icon" onclick="deleteCity({{$blog->id}})" rel="tooltip"  data-original-title="Delete Blog"><i class="material-icons">close</i></a>
