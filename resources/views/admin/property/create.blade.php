                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="panel1">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <!---- ADDRESS ------->
                                    @include('admin.property.includes.address',['cities'=>$cities])
                                    <!---- /ADDRESS ------->
                                    ...
                                    <!--  UPLOAD IMAGES   --->
                                    @include('admin.property.includes.upload_images')
                                    <!--  /UPLOAD IMAGES  --->

                                    <!---  OTHER DETAIL ----->
                                    @include('admin.property.includes.other_details')
                                    <!---  /OTHER DETAIL ----->
                                    ...
                                    <!---  OWNER DETAIL ----->
                                    @include('admin.property.includes.owner_details')
                                    <!---  /OWNER DETAIL ----->
                                    <br>
