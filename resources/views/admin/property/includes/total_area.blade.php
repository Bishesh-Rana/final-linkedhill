        ...
        <div class="panel-body">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group" style="margin-top:10px;">
                                {!! Form::select('built_up_area_unit', $units, old('built_up_area_unit', $property->built_up_area_unit), [
                ...
                <div class="col-md-6 ">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" style="margin-top:10px;">
                            {!! Form::select('total_area_unit', $units, old('total_area_unit', $property->total_area_unit), [
                                'class' => 'form-control select2',
                                'style' => 'width: 100%;',
                            ]) !!}
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group" style="margin-top:10px;">
                        ...
                        <select class="form-control select2 select2-hidden-accessible" name="property_facing"
                            data-placeholder="Select City" style="width: 100%;" tabindex="-1" aria-hidden="true"
                            required>
                            ...
                            <option value="South-East" @if ($property->property_facing == 'South-East') selected @endif>South-East
                            </option>
                            <option value="South-West" @if ($property->property_facing == 'South-West') selected @endif>South-West
                            </option>
                            <option value="North-East" @if ($property->property_facing == 'North-East') selected @endif>North-East
                            </option>
                            <option value="North-West" @if ($property->property_facing == 'North-West') selected @endif>North-West
                            </option>
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group label-floating">
                        ...
                        <input class="form-control" name="road_width"
                            value="{{ old('road_width', $property->road_access) }}" type="text"
                            placeholder="e.g 34,45" />
                        <x-error name='road_width' />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group" style="margin-top:15px;">
                        <label class="label-style">Road Width Unit</label>
                        <select class="form-control select2 select2-hidden-accessible" name="road_width_unit"
                            data-placeholder="Select Road Length Unit" style="width: 100%;" tabindex="-1"
                            aria-hidden="true" required>
                            <option value="Ft" @if ($property->road_access_unit == 'Ft') selected @endif>Ft</option>
                            <option value="M" @if ($property->road_access_unit == 'M') selected @endif>M</option>
                            <option value="Km" @if ($property->road_access_unit == 'Km') selected @endif>Km</option>
                            <option value="Haath" @if ($property->road_access_unit == 'Haath') selected @endif>Haath</option>
                        </select>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group" style="margin-top:15px;">
                        <label class="label-style">Mohoda Unit</label>
                ...
                <div class="col-md-4">
                    <div class="form-group" style="margin-top:15px;">
                        ...
                        {!! Form::select('road_type', $road_types, old('road_type', $property->road_type), [
                            'class' => 'form-control select2',
                            'style' => 'width: 100%;',
                        ]) !!}
