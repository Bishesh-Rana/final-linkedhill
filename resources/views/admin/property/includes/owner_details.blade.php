            ...
            <div id="mydetail" class="tab-pane fade in active">
                ...
                <div class="col-md-4">
                    <div class="form-group  label-floating">
                        ...
                        <input class="form-control" name="owner_name" value="{{ $property->owner_name }}" type="text"
                ...
                <div class="col-md-4">
                    <div class="form-group  label-floating">
                        ...
                        <input class="form-control" name="owner_address" value="{{ $property->owner_address }}"
                            type="text" data-parsley-trigger="keyup" required />
                        <x-error name='owner_address' />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group  label-floating">
                        ...
                        <input class="form-control" name="owner_phone" value="{{ $property->owner_phone }}"
                            type="text" data-parsley-trigger="keyup" data-parsley-type="number"
                            data-parsley-type-message="only numbers" required />
