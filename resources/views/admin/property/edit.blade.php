            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <form id="dropzoneForm" class="dropzone"  action="{{route('properties.update',$property->id)}}"  method="post" enctype="multipart/form-data"  data-parsley-validate="">
                        @csrf
                        @method('put')
...
@push('script')
    ...
    <script type="text/javascript">
        $(function () {
            $('#dropzoneForm').parsley().on('field:validated', function() {
