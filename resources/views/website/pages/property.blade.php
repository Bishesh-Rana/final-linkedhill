         ...
         <div class="row">
             <div class="col-lg-6">
                <div class="character_list_title">
                 ...
                 <h1>List of <span class="url_value"></span> Property</h1>
...
@push('scripts')
<script>
    // getting slug for property page eg: Residential, commercial, agriculture.(it is in title of page)
    var href = location.href;
    var url = href.match(/([^\/]*)\/*$/)[1];
    jQuery('.url_value').html(url);
</script>
@endpush
