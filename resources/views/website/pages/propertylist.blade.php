        ...
        <div class="propertylistsearch">
            <div class="first-row">
                <div class="row gx-0">
                    ...
                    <div class="col-md-2"><div class="filter"><span>Show filter</span><img class="img-fluid ms-3" src="{{asset('/assets/img/filter.png')}}" alt=""></div></div>
                    <div class="col-md-2">
            ...
            <div class="second-row">
                <div class="option_1 multi_select_dropdown">
                            ...
                            <div class="option_a1 moreOption">
                               <div class="moreOptionsToggler">More Options</div>
        ...
        <div class="container">
            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="property_thumbnail_">
                                                        ...
                                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                                          ...
                                                          <div onclick="favorite({{$property->id}})" class="favicon">
                                                            <a href="#" class="favorite{{$property->id}}"><i class=" lar la-heart "></i></a>
                                                          </div>
                                                    </div>
                                                    <div class="property_owner">
                                                        ...
                                                        <span
                                                            ...
                                                            <span class="type_badge">{{ $property->total_area . ' ' . $property->area_unit->name }}</span></span>
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="top_tt_title">
                                                        <a class="d-flex" href="{{ route('property.detail', ['id' => $property->id, 'slug' => $property->slug]) }}">
                ...
                <div class="col-lg-4 advertisement">
                    <div><h5>Featured Products</h5></div>
                    @forelse ($properties as $property)                                   
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="property_owner">
                                    ...
                                    @if ($property->bath !== 0)
                                        <span title="bathroom"><i class="las la-bath"></i><span class="type_badge">{{ $property->bath }}</span></span>
                                    @endif
                                    <span
                                        title="{{ $property->total_area . ' ' . $property->area_unit->name }}">
                                        <i class="las la-crop-alt"></i>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="top_tt_title">
                                    <a class="" href="{{ route('property.detail', ['id' => $property->id, 'slug' => $property->slug]) }}">
