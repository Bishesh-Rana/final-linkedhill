<div class="linked_hill_search_wrapper">
    ...
    <div class="container">
        <form class="searchProperty" id="searchProperty" method="get" action="{{ route('front.search-properties') }}">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="for_toggle_view">
                    <div class="link_hill_flex_bottom_wrapper">
                        ...
                        <div class="option_a1  advance-search">
                            <p>
                                <button data-bs-toggle="modal" data-bs-target="#advanceSearch" type="reset" value="reset" form="searchProperty">Advance Search</button></p>
