...
@section('title',$website->meta_title)

@push('metaTags')
    <meta name="keywords" content="{{$website->meta_keyword}}">
    ...
    <meta property="og:image" content="{{asset('images/'.$website->og_image)}}">
@endpush
...
@section('content')
    <main class="home-page">
        <section class="screen">
            ...
            <div class="absolute__wrapper">
                <div class="section-rule">
                    ...
                    @include('frontend.includes.homepage_search')
        ...
        <section class="feature cmm" id="scrolldown">
            <div class="section-rule">
                <div class="section__title--wrapper">
                    ...
                    <a href="{{route('featured.properties')}}" class="section__link"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
                ...
                <div class="carousel">
                    @foreach($properties as $property)
                        <article class="item">
                                <a class="card favProperty" href="{{route('property.detail',['id'=>$property->id,'slug'=>$property->slug])}}">
                                    <div class="card__img">
                                    ...
                                    <div class="card__body">
                                        ...
                                        <div class="card__action d-flex">
                                            ...
                                            <div>
                                                ...
                                                <label>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18.469" height="18.52" viewBox="0 0 18.469 18.52">
                                                    ...
                                                    {{$property->total_area}} {{$property->area_unit->name}}
                                                </label>
        ...
        <section class="property">
            <div class="section-rule">
                <div class="section__title--wrapper">
                    @if(count(\App\Models\City::first()->properties)>0)
                        ...
                        <div class="card">
                            ...
                            <div class="card__body">
                                ...
                                <div class="card__action d-flex">
                                    ...
                                    <h2 class="small__title">{{count($city->properties)}} Properties</h2>
                                </div>
                            </div>
            ...
            <div class="section-rule pb-0">
                ...
                <div class="carousel">
                    @foreach($premium_properties as $premium_property )
                        @php
                            $agentt = \App\Models\User::find(propertyAgent($premium_property->id));
                        @endphp
                    @if($agentt)
                        <article class="item">
                            <a class="card favProperty" href="{{route('property.detail',['id'=>$premium_property->id,'slug'=>$premium_property->slug])}}">
                                <div class="card__img">
                                ...
                                <div class="card__body">
                                    <div class="card__top d-flex align-items-start justify-content-between">
                                        ...
                                        <div  class="save @if(isFavouriteProperty($premium_property->id)) active @endif" id="fav{{$premium_property->id}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="27.208" height="24.206" viewBox="0 0 27.208 24.206">
                                                <path id="love-and-romance" d="M25.05,2.369A7.316,7.316,0,0,0,19.608,0a6.845,6.845,0,0,0-4.275,1.476A8.746,8.746,0,0,0,13.6,3.28a8.742,8.742,0,0,0-1.729-1.8A6.844,6.844,0,0,0,7.6,0,7.317,7.317,0,0,0,2.159,2.369,8.5,8.5,0,0,0,0,8.177a10.127,10.127,0,0,0,2.7,6.629,57.543,57.543,0,0,0,6.755,6.34c.936.8,2,1.7,3.1,2.665a1.6,1.6,0,0,0,2.1,0c1.1-.963,2.163-1.868,3.1-2.666a57.511,57.511,0,0,0,6.755-6.34,10.126,10.126,0,0,0,2.7-6.629A8.5,8.5,0,0,0,25.05,2.369Zm0,0" transform="translate(0)" fill="#dbdbdb"></path>
                                            </svg>
                                        </div>
                                        <input type="hidden" id="property_id" name="property_id" value="{{$premium_property->id}}">
                                    </div>

                                    <h2 class="price">NPR {{$premium_property->price}}</h2>
                                    <div class="card__action d-flex">
                                        <div>
                                            <label ><svg xmlns="http://www.w3.org/2000/svg" width="20.593" height="13.353" viewBox="0 0 20.593 13.353">
                                                    <g id="bed_2_" data-name="bed (2)" transform="translate(0)">
        ...
        @if(count($trending_properties)>0)
        <section class="feature listed cmm" >
            <div class="section-rule pb-0">
                <div class="section__title--wrapper">
                    <h2 class="section__title">Trending Property</h2>
                    <a href="{{route('trending.properties')}}" class="section__link"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
                            <path id="Union_6" data-name="Union 6" d="M.127,10.749V2.379L0,2.389.127.8,10.079,0,9.951,1.592l-8.232.66v8.5Z" transform="translate(14.727 7.6) rotate(135)" fill="#313131" opacity="0.8"/>
                        </svg>View More</a>
                </div>
                ...
                <div class="carousel">
                    @foreach($trending_properties as $trending_property)
                        @php
                            $agenttt = \App\Models\User::find(propertyAgent($trending_property->id));
                        @endphp
                    @if($agenttt)
                        <article class="item">
                            <a class="card favProperty" href="{{route('property.detail',['id'=>$trending_property->id,'slug'=>$trending_property->slug])}}">
                                <div class="card__img">
                                ...
                                <div class="card__body">
                                    <div class="card__top d-flex align-items-start justify-content-between">
                                        ...
                                        <div  class="save @if(isFavouriteProperty($trending_property->id)) active @endif" id="fav{{$trending_property->id}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="27.208" height="24.206" viewBox="0 0 27.208 24.206">
                                                <path id="love-and-romance" d="M25.05,2.369A7.316,7.316,0,0,0,19.608,0a6.845,6.845,0,0,0-4.275,1.476A8.746,8.746,0,0,0,13.6,3.28a8.742,8.742,0,0,0-1.729-1.8A6.844,6.844,0,0,0,7.6,0,7.317,7.317,0,0,0,2.159,2.369,8.5,8.5,0,0,0,0,8.177a10.127,10.127,0,0,0,2.7,6.629,57.543,57.543,0,0,0,6.755,6.34c.936.8,2,1.7,3.1,2.665a1.6,1.6,0,0,0,2.1,0c1.1-.963,2.163-1.868,3.1-2.666a57.511,57.511,0,0,0,6.755-6.34,10.126,10.126,0,0,0,2.7-6.629A8.5,8.5,0,0,0,25.05,2.369Zm0,0" transform="translate(0)" fill="#dbdbdb"></path>
                                            </svg>
                                        </div>
                                        <input type="hidden" id="property_id" name="property_id" value="{{$trending_property->id}}">
                                    </div>

                                    <h2 class="price">NPR {{$trending_property->price}}</h2>
                                    <div class="card__action d-flex">
                                        <div>
                                            <label ><svg xmlns="http://www.w3.org/2000/svg" width="20.593" height="13.353" viewBox="0 0 20.593 13.353">
                                                    <g id="bed_2_" data-name="bed (2)" transform="translate(0)">
        ...
        @if(count($services)>0)
        <section class="trade" style="margin-top: 50px">
            <div class="section-rule p-0">
                ...
                <div class="row">
                    ...
                    <article class="col-sm-6 col-md-4 col-lg-3">
                        <a href="{{route('service.serviceProvider',$service->slug)}}" class="card">
                            <div class="card__img">
                                <img src="{{$service->image}}" alt="">
                            </div>
                            <h2 class="card__title">
                                {{$service->name}} ({{count($service->vendors)}})
                            </h2>
        ...
        <section class="blog">
            <div class="section-rule">
                <div class="section__title--wrapper">
                    ...
                    <a href="{{route('blogs')}}" class="section__link"><svg xmlns="http://www.w3.org/2000/svg" width="14.727" height="14.727" viewBox="0 0 14.727 14.727">
                            <path id="Union_6" data-name="Union 6" d="M.127,10.749V2.379L0,2.389.127.8,10.079,0,9.951,1.592l-8.232.66v8.5Z" transform="translate(14.727 7.6) rotate(135)" fill="#313131" opacity="0.8"/>
                        </svg>View More</a>
                </div>
                ...
                <div class="row">
                    @foreach($blogs as $blog)
                        <article class="col-md-4">
                            <div class="card">
                                <a href="{{route('blog.single',['id'=>$blog->id,'slug'=>$blog->slug])}}">
                                <div class="card__img">
    ...
    <section class="join">
        <div class="section-rule">
            <div class="section__title--wrapper plus">
                ...
                <button onclick="window.location.href='{{route('sign.up')}}'">Join Us</button>
            </div>
        </div>
    </section>
@endsection
