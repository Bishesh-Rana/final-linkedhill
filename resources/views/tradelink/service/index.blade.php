            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header card-header-icon">
                        ...
                        <a href="{{route('service-list.create')}}" class="btn btn-sm pull-right" style="margin-top: -30px"><span class="material-icons">add</span> &nbsp;Add</a>
                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($services as $service)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-md-1">
                                                <a href="{{route('service-list.edit',$service->id)}}" class="btn btn-simple btn-warning btn-icon edit" rel="tooltip"  data-original-title="Edit Service"><i class="material-icons">edit</i></a>
                                            </div>
                                            <div class="col-md-1">
...
//            "pagingType": "full_numbers",
    ...
    function deleteService(id) {
        ...
        swal({
            ...
            $.ajax({
                url:'{!!URL::to('tradelink/service-list/')!!}' + '/' + id,
                type : "POST",
