...
<div class="wrapper wrapper-full-page">
    <div class="full-page login-page" filter-color="blue" data-image="{{asset('dashboard/img/foodtable.jpg')}}">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        ...
                        <form method="POST" action="{{route('tradelink.login')}}">
                            @csrf
                            <div class="card card-login">
                                ...
                                <div class="text-center" style="margin-top: 15px">
                                    <h4 class="card-title">Tradelink Login</h4>
                                    <br>
                                </div>
