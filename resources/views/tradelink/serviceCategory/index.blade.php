                            ...
                            <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{$category->name}}</td>
                                        <td>
                                            <a href="{{$category->image}}" data-lightbox="example{{$category->id}}"><img class="img-style" src="{{$category->image}}" /></a>
                                        </td>
                                        <td class="text-right">
        ...
        @foreach($categories as $category)
            <div class="modal fade" id="exampleModal-{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <form action="{{route('service-category.update',$category->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="form-group label-floating is-empty">
                                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                ...
                                                <img src="{{$category->image}}" id="image" class="img-thumbnail img-responsive" alt="">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group  label-floating">
                                        ...
                                        <input class="form-control" name="slug" id="slug" value="{{$category->slug}}" type="text"  />
                                    </div>
                                </div>
